...
class ResourceSchemaArgument(object):
    ...
    def __init__(self, argument_name=None, mandatory=None):  # noqa: E501
        """ResourceSchemaArgument - a model defined in Swagger"""  # noqa: E501
    ...
    def argument_name(self):
        """Gets the argument_name of this ResourceSchemaArgument.  # noqa: E501

        Name of the argument. Should be of pattern [a-zA-Z][a-zA-Z0-9_-]*  # noqa: E501

        :return: The argument_name of this ResourceSchemaArgument.  # noqa: E501
        :rtype: str
        """
    ...
    def argument_name(self, argument_name):
        """Sets the argument_name of this ResourceSchemaArgument.

        Name of the argument. Should be of pattern [a-zA-Z][a-zA-Z0-9_-]*  # noqa: E501

        :param argument_name: The argument_name of this ResourceSchemaArgument.  # noqa: E501
        :type: str
        """
    ...
    @property
    def mandatory(self):
        """Gets the mandatory of this ResourceSchemaArgument.  # noqa: E501

        Flag to indicate a mandatory attribute  # noqa: E501

        :return: The mandatory of this ResourceSchemaArgument.  # noqa: E501
    ...
    def mandatory(self, mandatory):
        """Sets the mandatory of this ResourceSchemaArgument.

        Flag to indicate a mandatory attribute  # noqa: E501

        :param mandatory: The mandatory of this ResourceSchemaArgument.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResourceSchemaArgument, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceSchemaArgument):
            return False
