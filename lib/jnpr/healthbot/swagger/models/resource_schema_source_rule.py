...
class ResourceSchemaSourceRule(object):
    ...
    def __init__(self, field_name=None, rule_name=None):  # noqa: E501
        """ResourceSchemaSourceRule - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def field_name(self):
        """Gets the field_name of this ResourceSchemaSourceRule.  # noqa: E501

        Rule field name from where resource field should be populated. Should be of pattern [a-z][a-zA-Z0-9_-]*  # noqa: E501

        :return: The field_name of this ResourceSchemaSourceRule.  # noqa: E501
        :rtype: str
        """
    ...
    def field_name(self, field_name):
        """Sets the field_name of this ResourceSchemaSourceRule.

        Rule field name from where resource field should be populated. Should be of pattern [a-z][a-zA-Z0-9_-]*  # noqa: E501

        :param field_name: The field_name of this ResourceSchemaSourceRule.  # noqa: E501
        :type: str
        """
    ...
    @property
    def rule_name(self):
        """Gets the rule_name of this ResourceSchemaSourceRule.  # noqa: E501
        ...
        :return: The rule_name of this ResourceSchemaSourceRule.  # noqa: E501
        :rtype: str
        """
    ...
    def rule_name(self, rule_name):
        """Sets the rule_name of this ResourceSchemaSourceRule.

        Rule name from where the resource needs to be discovered. Format: <topic-name>/<rule-name>. Should be of pattern [a-z][a-z-]*(\\.{1}[a-z0-9-]+)*/[a-z][a-z0-9_-]*  # noqa: E501

        :param rule_name: The rule_name of this ResourceSchemaSourceRule.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResourceSchemaSourceRule, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResourceSchemaSourceRule):
            return False
